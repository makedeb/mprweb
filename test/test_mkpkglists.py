...
def test_mkpkglists():
    ...
    with open(f"{mkpkglists.archivedir}/packages.gz", "br") as file:
    ...
    with open(f"{mkpkglists.archivedir}/pkgbase.gz", "br") as file:
        packages = gzip.decompress(file.read()).decode().splitlines()
    ...
    with open(f"{mkpkglists.archivedir}/users.gz", "br") as file:
    ...
    with open(f"{mkpkglists.archivedir}/packages-meta-v1.json.gz", "br") as file:
    ...
    with open(f"{mkpkglists.archivedir}/packages-meta-ext-v2.json.gz", "br") as file:
        data = gzip.decompress(file.read()).decode()
